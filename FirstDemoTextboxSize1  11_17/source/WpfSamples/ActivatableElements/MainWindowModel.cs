...
namespace ActivatableElements
{
    ...
    public class MainWindowModel
    {
        ...
        {   // Possible Ranges (0-8),(0-10)
            ...
            notes.Add(new Note(id++, 15, 9, Colors.White, System.Windows.Media.Brushes.DarkBlue));                   // 16
            notes.Add(new Note(id++, 16, 9, Colors.White, System.Windows.Media.Brushes.DarkBlue));                   // 17
            ...
            notes.Add(new Note(id++, 14, 10, Colors.White, System.Windows.Media.Brushes.DarkBlue));                   // 15
            notes.Add(new Note(id++, 15, 10, Colors.White, System.Windows.Media.Brushes.DarkBlue));                   // 16
            notes.Add(new Note(id++, 16, 10, Colors.White, System.Windows.Media.Brushes.DarkBlue));                   // 17
