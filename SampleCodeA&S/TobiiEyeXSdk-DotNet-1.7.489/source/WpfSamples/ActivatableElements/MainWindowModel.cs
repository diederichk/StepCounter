...
namespace ActivatableElements
{
    ...
    public class MainWindowModel
    {
        ...
        public void ActivateNote(Note activatedNote)
        {
            ...
            _notes.Add(new Note(activatedNote.Id, activatedNote.ColumnIndex, activatedNote.RowIndex, Colors.Lavender));
        ...
        {
            var id = 0;
            notes.Add(new Note(id++, 1, 1, Colors.Aqua));
            notes.Add(new Note(id++, 1, 4, Colors.Aqua));
            notes.Add(new Note(id++, 1, 7, Colors.Aqua));
            /*notes.Add(new Note(id++, 2, 1, Colors.LightGoldenrodYellow));
            notes.Add(new Note(id++, 2, 2, Colors.Aqua));
            notes.Add(new Note(id++, 2, 3, Colors.Aquamarine));
            notes.Add(new Note(id++, 3, 1, Colors.LightPink));
            notes.Add(new Note(id++, 3, 2, Colors.LightGoldenrodYellow));
            notes.Add(new Note(id++, 3, 3, Colors.Aqua));
    ...
    public class Note
    {
       ...
       /* public SolidColorBrush changeColor(Color color)
        {
